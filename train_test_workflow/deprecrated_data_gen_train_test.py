...
if data_gen_qts == 1:
    ...
    if (data_gen_lensed == 1) and (data_gen_train == 1):
        ...
        os.system(
            'nohup lensid_create_qts_lensed_injs -odir %s -start %d -n %d -infile  %s -psd_mode %d -asd_dir %s -qrange %d -mode 1 -whitened %d >%s.out &' %
            (base_out_dir +
             out_dir_qts +
             '/train/lensed',
    ...
    if (data_gen_unlensed == 1) and (data_gen_train == 1):
        ...
        os.system(
            'nohup lensid_create_qts_unlensed_injs -odir %s -start %d -n %d -infile  %s -psd_mode %d -asd_dir %s -qrange %d -mode 1 -whitened %d >%s.out &' %
            (base_out_dir +
             out_dir_qts +
             '/train/unlensed',
    ...
    if (data_gen_lensed == 1) and (data_gen_test == 1):
        ...
        os.system(
            'nohup lensid_create_qts_lensed_injs -odir %s -start %d -n %d -infile  %s -psd_mode %d -asd_dir %s -qrange %d -mode 2 -whitened %d >%s.out &' %
            (base_out_dir +
             out_dir_qts +
             '/test/lensed',
    ...
    if (data_gen_unlensed == 1) and (data_gen_test == 1):
        ...
        os.system(
            'nohup lensid_create_qts_unlensed_injs -odir %s -start %d -n %d -infile  %s -psd_mode %d -asd_dir %s -qrange %d -mode 2 -whitened %d >%s.out &' %
            (base_out_dir +
             out_dir_qts +
             '/test/unlensed',
...
if data_gen_sky == 1:
    ...
    if (data_gen_lensed == 1) and (data_gen_train == 1):
        ...
        os.system(
            'nohup lensid_create_bayestar_sky_lensed_injs.sh -o %s -s %d -n %d -i %s -p %s  >%s.out &' %
            (base_out_dir +
             out_dir_sky +
             '/train',
             start_idx_train_lensed,
    ...
    if (data_gen_unlensed == 1) and (data_gen_train == 1):
        ...
        os.system(
            'nohup lensid_create_bayestar_sky_unlensed_injs.sh -o %s -s %d -n %d -i %s -p %s  >%s.out &' %
            (base_out_dir +
             out_dir_sky +
             '/train',
             start_idx_train_unlensed,
