...
setup(name="lensid",
    ...
    packages=["lensid","lensid.utils","lensid.injections","lensid.feature_extraction"],
    ...
    entry_points = {
        'console_scripts': [
            ...
            'lensid_create_unlensed_inj_xmls=lensid.injections.lensid_create_unlensed_inj_xmls:main',
