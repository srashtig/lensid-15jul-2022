...
def main():
    parser = argparse.ArgumentParser(
        description='This is stand alone code for converting .fits skymaps to .npz for lensed unlensed injections')
    ...
    parser.add_argument(
        ...
        '--index',
        type=int,
        help='index of injection file',
        required=True)
    parser.add_argument(
        '-lensed',
        '--lensed',
        help='lensed injection? y/n',
        default='n')
    parser.add_argument(
        '-infile',
        '--infile',
    ...
    if args.lensed == 'n':
        ...
        fname_img1 = str(lensed_data['event_tag'][index]) + \
            '_' + str(lensed_data['img_tag'][index, 0])
        fname_img2 = str(lensed_data['event_tag'][index]) + \
            '_' + str(lensed_data['img_tag'][index, 1])
