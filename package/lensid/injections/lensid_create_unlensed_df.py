...
import argparse
def main():
    parser = argparse.ArgumentParser(description='This is stand alone code for generating unlensed dataframe for testing ML lensing classification')

    parser.add_argument('-odir','--odir', help='Output directory',default='check')
    parser.add_argument('-outfile','--outfile', help='dataframe name(.csv)',default = 'unlensed.csv')
